            ...
            <div className="px-5 pt-4">
              ...
              >
                ...
                <p className="mt-1 text-caption text-gray-500">
                  가벼운 제형 선호도 + 여름철 지성 고민 기반으로 피지 조절 강화
                  제품을 우선 추천했어요
                </p>
              </section>
                  ...
                  <div className="flex gap-3 overflow-x-auto pb-1 scrollbar-none">
                    {similarUserProducts.map((product) => (
                      ...
                      >
                        ...
                        <div className="mt-2 flex items-center justify-between">
                          <span className="truncate text-caption text-gray-300">
                            {product.brand}
                          </span>
      ...
      {trackingCount !== null && (
        <div className="fixed bottom-[84px] left-1/2 z-30 w-full max-w-[430px] -translate-x-1/2 px-4">
          <button
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(91,143,217,0.18) 0%, rgba(155,191,238,0.14) 100%)",
          ...
          >
            ...
            <span
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(91,143,217,0.35), rgba(53,101,181,0.25))",
            ...
            <div className="flex-1 text-left">
              <p className="text-caption font-semibold text-primary-600">
                가격 추적
              </p>
