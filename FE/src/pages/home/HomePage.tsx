...
export function HomePage() {
  ...
  return (
    <AppLayout>
      <section className="min-h-screen overflow-hidden pb-[148px]">
        {/* Spline 헤더 영역 */}
      ...
      {trackingCount !== null && (
        <div className="fixed bottom-[72px] left-1/2 z-30 w-full max-w-[430px] -translate-x-1/2 px-4">
          <button
            className="flex w-full items-center gap-3 rounded-2xl border border-primary-100 px-5 py-3.5 text-gray-500 shadow-sm"
            style={{ background: "#F0F5FD" }}
          ...
          >
            <span
              ...
              style={{ background: "#DBE6F8" }}
            >
              📊
            </span>
            <div className="flex-1 text-left">
              <p className="text-caption text-primary-700">가격 추적</p>
