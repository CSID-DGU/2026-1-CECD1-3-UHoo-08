...
export function ProfileEditPage() {
    ...
    getMyProfile()
      .then((res) => {
        ...
        if (u.profileImageUrl)
          setPreviewUrl(getProfileImageUrl(u.profileImageUrl));
      })
      .catch(() => {});
  }, []);
  ...
  async function handleSave() {
    ...
    setLoading(true);
    try {
      await updateProfile(name.trim() || null, gender, imageFile);
      navigate("/my");
    } catch {
          ...
          <section className="flex flex-col px-6 pb-8 pt-10">
            ...
            >
              <div className="relative mx-auto h-[120px] w-[120px]">
                ...
                <span className="absolute bottom-1 right-0 flex h-9 w-9 items-center justify-center rounded-full border-2 border-white bg-primary-500">
                  <svg
                    aria-hidden="true"
                  ...
                  >
                    ...
                    />
                    <path
                      d="M9 12.5a3 3 0 1 0 6 0 3 3 0 0 0-6 0Z"
                      stroke="currentColor"
                      strokeWidth="2"
                    />
                  </svg>
              ...
              <span className="mt-3 block text-caption text-gray-300">
                프로필 사진 선택
              </span>
            </button>
            ...
            <button
              className="mt-6 h-14 w-full rounded-xl bg-primary-500 text-body1 text-white disabled:opacity-50"
              disabled={loading}
              onClick={handleSave}
              type="button"
            >
